...
- To give a single set of credentials access to several unrelated locations under names you choose, use [virtual folders](./setting-up-virtual-folders.md) instead of a single home directory.
