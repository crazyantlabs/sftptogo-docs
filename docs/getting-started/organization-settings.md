...
The setting applies to web portal sessions and shared folder links alike. Changes take effect on new sessions and on the next folder refresh for active ones.
